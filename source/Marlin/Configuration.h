...
#define STRING_CONFIG_H_AUTHOR "(EndlessIllusion, 20230212)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 213.37
  #define DEFAULT_bedKi 26.46
  #define DEFAULT_bedKd 1146.23
...
#if EITHER(ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, ANYCUBIC_LCD_DGUS)
